...
function FaqAdmin() {
	...
	if (isset($faq_categ)) {
		...
		print("<tr><td class=\"colhead\" align=\"center\" colspan=\"2\">Pozīcija</td><td class=\"colhead\" align=\"left\">Sekcija/Nosaukums</td><td class=\"colhead\" align=\"center\">Status</td><td class=\"colhead\" align=\"center\">Darbība</td></tr>\n");
		...
		$status = ($faq_categ[$id]["flag"] == "0") ? "<font color=\"red\">Slēpts</font>" : "Parasts";
		print("</select></td><td align=\"center\" width=\"40px\">&nbsp;</td><td><b>". $faq_categ[$id]["title"] ."</b></td><td align=\"center\" width=\"60px\">". $status ."</td><td align=\"center\" width=\"60px\"><a href=\"$admin_file.php?op=FaqAction&action=edit&id=". $id ."\">L</a> / <a href=\"$admin_file.php?op=FaqAction&action=delete&id=". $id ."\">D</a></td></tr>\n");
		...
		if (array_key_exists("items", $faq_categ[$id])) {
			foreach ($faq_categ[$id]["items"] as $id2 => $temp) {
				...
				if ($faq_categ[$id]["items"][$id2][flag] == "0") $status = "<font color=\"#FF0000\">Slēpts</font>";
				elseif ($faq_categ[$id]["items"][$id2][flag] == "2") $status = "<font color=\"#0000FF\"><img src=\"".$rootpath.$pic_base_url."updated.png\" alt=\"Atjaunots\" align=\"absbottom\"></font>";
				elseif ($faq_categ[$id]["items"][$id2][flag] == "3") $status = "<font color=\"#008000\"><img src=\"".$rootpath.$pic_base_url."new.png\" alt=\"Jauns\" align=\"absbottom\"></font>";
				else $status = "Parasts";
				print("</select></td><td>". $faq_categ[$id]["items"][$id2]["question"] ."</td><td align=\"center\" width=\"60px\">". $status ."</td><td align=\"center\" width=\"60px\"><a href=\"$admin_file.php?op=FaqAction&action=edit&id=". $id2 ."\">L</a> / <a href=\"$admin_file.php?op=FaqAction&action=delete&id=". $id2 ."\">D</a></td></tr>\n");
			}
		}

		print("<tr><td colspan=\"5\" align=\"center\"><a href=\"$admin_file.php?op=FaqAction&action=additem&inid=". $id ."\">Pievienot jaunu elementu</a></td></tr>\n");
		print("</table>\n");
		}
	}
	...
	if (isset($faq_orphaned)) {
		print("<br />\n<table border=\"1\" cellspacing=\"0\" cellpadding=\"5\" align=\"center\" width=\"95%\">\n");
		print("<tr><td align=\"center\" colspan=\"3\"><b style=\"color: #FF0000\">Dzēst elementu</b></td>\n");
		print("<tr><td class=\"colhead\" align=\"left\">Item Title</td><td class=\"colhead\" align=\"center\">Status</td><td class=\"colhead\" align=\"center\">Darbības</td></tr>\n");
		foreach ($faq_orphaned as $id => $temp) {
			if ($faq_orphaned[$id]["flag"] == "0") $status = "<font color=\"#FF0000\">Slēpts</font>";
			elseif ($faq_orphaned[$id]["flag"] == "2") $status = "<font color=\"#0000FF\">Atjaunots</font>";
			elseif ($faq_orphaned[$id]["flag"] == "3") $status = "<font color=\"#008000\">Jauns</font>";
			else $status = "Parasts";
			print("<tr><td>". $faq_orphaned[$id]["question"] ."</td><td align=\"center\" width=\"60px\">". $status ."</td><td align=\"center\" width=\"60px\"><a href=\"$admin_file.php?op=FaqAction&action=edit&id=". $id ."\">labot</a> <a href=\"$admin_file.php?op=FaqAction&action=delete&id=". $id ."\">dzēst</a></td></tr>\n");
		}
		print("</table>\n");
	}

	print("<br />\n<table border=\"1\" cellspacing=\"0\" cellpadding=\"5\" align=\"center\" width=\"95%\">\n<tr><td align=\"center\"><a href=\"$admin_file.php?op=FaqAction&action=addsection\">Pievienot jaunu nodaļu</a></td></tr>\n</table>\n");
	print("<p align=\"center\"><input type=\"submit\" name=\"reorder\" value=\"Kārtot\" class=\"btn\"></p>\n");
	print("</form>\n");
}
...
function FaqAction() {
	...
	if ($arr[type] == "item") {
		...
		print("<tr><td>Jautājums:</td><td><input id=specialboxg type=\"text\" name=\"question\" value=\"$arr[question]\" size=50 /></td></tr>\n");
		print("<tr><td style=\"vertical-align: top;\">Atbilde:</td><td><textarea id=specialboxg rows=15 cols=80 name=\"answer\">$arr[answer]</textarea></td></tr>\n");
		print("<tr><td>Status:</td><td><select name=\"flag\" style=\"width: 110px;\"><option value=\"0\" style=\"color: #FF0000;\"".($arr['flag'] == 0 ? " selected" : "").">Slēpts</option><option value=\"1\" style=\"color: #000000;\"".($arr['flag'] == 1 ? " selected" : "").">Parasts</option><option value=\"2\" style=\"color: #0000FF;\" ".($arr['flag'] == 2 ? "selected" : "").">Atjaunots</option><option value=\"3\" style=\"color: #008000;\" ".($arr['flag'] == 3 ? "selected" : "").">Jauns</option></select></td></tr>");

		print("<tr><td>Kategorija:</td><td><select style=\"width: 300px;\" name=\"categ\" />");
		...
		print("</td></tr>\n");
		print("<tr><td colspan=\"2\" align=\"center\"><input type=\"submit\" name=\"edit\" value=\"Labot\" class=\"btn\"></td></tr>\n");
		print("</table>");
	}
	elseif ($arr[type] == "categ") {
		...
		print("<tr><td>ID:</td><td>$arr[id] <input type=\"hidden\" name=\"id\" value=\"$arr[id]\" /></td></tr>\n");
		print("<tr><td>Nosaukums:</td><td><input style=\"width: 300px;\" type=\"text\" name=\"title\" value=\"$arr[question]\" id=specialboxn /></td></tr>\n");
		if ($arr[flag] == "0")
			print("<tr><td>Status:</td><td><select name=\"flag\" style=\"width: 110px;\"><option value=\"0\" style=\"color: #FF0000;\">Slēpts</option><option value=\"1\" style=\"color: #000000;\">Parasts</option></select></td></tr>");
		else
			print("<tr><td>Status:</td><td><select name=\"flag\" style=\"width: 110px;\"><option value=\"0\" style=\"color: #FF0000;\"".($arr['flag'] == 0 ? " selected" : "").">Slēpts</option><option value=\"1\" style=\"color: #000000;\"".($arr['flag'] == 1 ? " selected" : "").">Parasts</option></select></td></tr>");
		print("<tr><td colspan=\"2\" align=\"center\"><input type=\"submit\" class=btn name=\"edit\" value=\"Labot\"></td></tr>\n");
		print("</table>");
	}
	}
	...
	elseif ($_GET["action"] == "delete" && isset($_GET["id"])) {
		if ($_GET["confirm"] == "yes") {
			...
			print("<h1 align=\"center\">Apsiprinājums nepieciešams</h1>");
			print("<table border=\"1\" cellspacing=\"0\" cellpadding=\"5\" align=\"center\" width=\"95%\">\n<tr><td align=\"center\">Spied <a href=\"$admin_file.php?op=FaqAction&action=delete&id=$_GET[id]&confirm=yes\">šeit</a> lai apsiprinātu.</td></tr>\n</table>\n");
		}
	}

	// ACTION: additem - add a new item
	elseif ($_GET[action] == "additem" && $_GET["inid"]) {
		print("<h2>Pievienot</h2>");
		print("<form method=\"post\" action=\"$admin_file.php?op=FaqAction&action=addnewitem\">");
		print("<table border=\"1\" cellspacing=\"0\" cellpadding=\"5\" align=\"center\" width=\"100%\">\n");
		print("<tr><td>Jautājums:</td><td><input id=specialboxg type=\"text\" name=\"question\" value=\"\" /></td></tr>\n");
		print("<tr><td style=\"vertical-align: top;\">Atbilde:</td><td><textarea id=specialboxg rows=15 cols=80 name=\"answer\"></textarea></td></tr>\n");
		print("<tr><td>Status:</td><td><select name=\"flag\" style=\"width: 110px;\"><option value=\"0\" style=\"color: #FF0000;\">Slēpts</option><option value=\"1\" style=\"color: #000000;\">Parasts</option><option value=\"2\" style=\"color: #0000FF;\">Atjaunots</option><option value=\"3\" style=\"color: #008000;\">Jauns</option></select></td></tr>");
		print("<tr><td>Kategorija:</td><td><select style=\"width: 300px;\" name=\"categ\" />");
		...
		print("</td></tr>\n");
		print("<tr><td colspan=\"2\" align=\"center\"><input type=\"submit\" class=\"btn\" name=\"edit\" value=\"Pievienot\"></td></tr>\n");
		print("</table>");
	}

	// ACTION: addsection - add a new section
	elseif ($_GET[action] == "addsection") {
		print("<h2>Pievienot jautājumu</h2>");
		print("<form method=\"post\" action=\"$admin_file.php?op=FaqAction&action=addnewsect\">");
		print("<table border=\"1\" cellspacing=\"0\" cellpadding=\"5\" align=\"center\" width=\"100%\">\n");
		print("<tr><td>Nosaukums:</td><td><input style=\"width: 600px;\" type=\"text\" name=\"title\" value=\"\" id=specialboxn /></td></tr>\n");
		print("<tr><td>Status:</td><td><select name=\"flag\" style=\"width: 110px;\"><option value=\"0\" style=\"color: #FF0000;\">Slēpts</option><option value=\"1\" style=\"color: #000000;\">Parasts</option></select></td></tr>");
		print("<tr><td colspan=\"2\" align=\"center\"><input type=\"submit\" name=\"edit\" value=\"Pievienot\" class=\"btn\" style=\"width: 60px;\"></td></tr>\n");
		print("</table>");
	}
