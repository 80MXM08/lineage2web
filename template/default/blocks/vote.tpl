...
<ul>
<li class="vote"><b>1.</b> <a href="login.php">{_login}</a></li>
<li class="vote"><b>2.</b> <a href="vote.php">{_vote}</a></li>
<li class="vote"><b>3.</b> <a href="webpoints.php">{get_reward}</a></li></ul></td></tr>
